    ...
    <span x-show="!sidebarCollapsed" class="ml-3 whitespace-nowrap">Categorías</span>
                ...
                <a href="{{ route('admin.courses.index') }}" 
                   class="group flex items-center px-3 py-3 text-sm font-medium rounded-lg transition-colors duration-200
                    ...
                    <i class="fas fa-book-open text-lg w-6 text-center transition-transform group-hover:scale-110 {{ request()->routeIs('admin.courses.*') ? 'text-white' : 'text-gray-400 group-hover:text-white' }}"></i>
                ...
                <a href="{{ route('admin.users.index') }}" 
                   class="group flex items-center px-3 py-3 text-sm font-medium rounded-lg transition-colors duration-200
                    ...
                    <i class="fas fa-users text-lg w-6 text-center transition-transform group-hover:scale-110 {{ request()->routeIs('admin.users.*') ? 'text-white' : 'text-gray-400 group-hover:text-white' }}"></i>
                ...
                class="group flex items-center px-3 py-3 text-sm font-medium rounded-lg transition-colors duration-200
                    ...
                    <i class="fas fa-graduation-cap text-lg w-6 text-center transition-transform group-hover:scale-110 {{ request()->routeIs('admin.enrollments.*') ? 'text-white' : 'text-gray-400 group-hover:text-white' }}"></i>
